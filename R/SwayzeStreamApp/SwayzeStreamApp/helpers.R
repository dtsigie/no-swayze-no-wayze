...
plot.stream <- function(
  x, y, 
  order.method = "max", frac.rand=0.001, spar=0.3,
  center=TRUE,
...
# polygon(out1[[2]], border=border[2], col=col[2], lwd=lwd[2])
# polygon(out1[[3]], border=border[3], col=col[3], lwd=lwd[3])
# polygon(out1[[1]], border=border[1], col=col[1], lwd=lwd[1])
}